    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">CodeJourney</span>
            </div>
            <p className="text-background/80 text-sm">
              Empowering developers to learn, build, and get hired.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="mailto:hello@codejourney.dev"
                className="hover:text-primary transition-colors"
                aria-label="Email"
              >
        ...
        <div className="border-t border-background/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-background/80">
          <p>&copy; {currentYear} CodeJourney. All rights reserved.</p>
